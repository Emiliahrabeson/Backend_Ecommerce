...
export function top_client() {
  const result = db.query(
    "SELECT u.user_id,u.name,u.email,u.city,COUNT(o.order_id) AS nb_commandes,SUM(o.total_amount) AS montant_total FROM users u INNER JOIN orders o ON u.user_id = o.user_id WHERE o.order_status = 'Completed' GROUP BY u.user_id, u.name, u.email, u.city ORDER BY nb_commandes DESC, montant_total DESC LIMIT 10"
  );
